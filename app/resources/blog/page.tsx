  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Every month, businesses pay thousands in AI subscriptions, funding their own obsolescence. Discover why ownership beats access every time.',
    ...
    },
    {
      ...
      excerpt:
        'Static AI is expensive stupidity. Learn how compound intelligence creates exponential advantages that grow daily.',
    ...
    },
    {
      ...
      excerpt:
        'Real stories of small businesses using sovereign AI to compete with—and beat—enterprises 100x their size.',
      date: 'January 5, 2025',
    ...
    },
    {
      ...
      excerpt:
        "Beyond monthly fees lies a darker truth: you're training their models with your innovations. Here's the real cost.",
    ...
    },
    {
      ...
      excerpt:
        'Cut through the hype. A practical, no-nonsense guide to implementing AI that actually drives revenue.',
      ...
      <div className="space-y-12">
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Cutting through AI hype with insights that actually help SMBs win. No fluff. No vendor propaganda. Just truth.
          </p>
        </section>
        ...
        {blogPosts
          ...
          .map((post) => (
            <div
              key={post.id}
              className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 backdrop-blur-sm rounded-xl p-8 border border-purple-500/30"
            >
              <div className="flex items-center gap-2 mb-4">
                <span className="text-xs font-semibold px-3 py-1 bg-purple-500/20 text-purple-300 rounded-full">FEATURED</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href={`/resources/blog/${post.id}`} className="flex items-center gap-2 text-purple-400 hover:text-purple-300 font-medium">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href={`/resources/blog/${post.id}`} className="text-sm text-purple-400 hover:text-purple-300">
                        Read more →
                      </Link>
                    </div>
                  </div>
        ...
        <section className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-sm rounded-xl p-12 border border-purple-500/30 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Get Intelligence That Gives You an Edge</h2>
          ...
          <p className="text-xs text-gray-500 mt-4">No spam. Unsubscribe anytime. We respect your sovereignty.</p>
        </section>
      </div>
    </ConsciousPage>
  );
